...
class ViewController: UIViewController {
    ...
    //        let cgPoint = sender.location(in: map) // receive the click on the map&get the Latitude and Longitude from this click
    //now we need to onvert x,y to latitude and longitutde
    ...
    //important: we do not want to put marker on the map ourselves because that will come from Firebase
    //    }
    ...
    fileprivate func createDemoMarker() {
        ...
        marker.title = "Fancy go here?" // a message on the marker
